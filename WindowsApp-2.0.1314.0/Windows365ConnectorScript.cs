...
public class Windows365ConnectorScript : ConnectorScriptBase
{
    ...
    private void SelectCloudPc()
    {
        ...
        _cancellationToken.ThrowIfCancellationRequested();
        var connectCard = devicesWindow.FindAutomationElementByXPathOrInformation($"//Document/Group/Group/Group/Group/Button[@Name=\"Connect to {CloudPcTitle}. Press Enter to connect.\"]",
